            ...
            TableRow(children: [
              const Padding(
                  ...
                  child: Text('Type',
                      ...
                      textAlign: TextAlign.left)),
              Padding(
                  padding: registration['injuryType'] == 'Blodutredning'
                      ? EdgeInsets.symmetric(
                          vertical: tableCellPadding.vertical)
                      : tableCellPadding,
                  child: Text(
                    '${registration['injuryType']}',
                    style: registration['injuryType'] == 'Blodutredning'
                        ? TextStyle(
                            fontSize: registrationDetailsDescriptionTextStyle
                                    .fontSize! -
                                2)
